...
.|".TRANS('MNL_PREVENTIVA')."|||".$iconsPath."edit-clear.png|centro
..|".TRANS('MNL_PREVENTIVA_SEM')."|".$invDirPath."prev_sem_ch.php||".$iconsPath."edit-clear.png|centro
..|".TRANS('MNL_PREVENTIVA_COM')."|".$invDirPath."prev_com_ch.php||".$iconsPath."edit-clear.png|centro";
...
..|".TRANS('MNL_CONF_MENSAGENS')."|".$admDirPath."mensagem.php|||centro
...
..|".TRANS('MNL_PREVENTIVA')."|".$admDirPath."preventiva.php|||centro
..|".TRANS('MNL_CONF_MAQIMPORT')."|".$admDirPath."maq_importadas.php|||centro
