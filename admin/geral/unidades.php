<?php 
  ...
  */session_start();
	...
	if ((!isset($_GET['action'])) and !isset($_POST['submit'])){
		...
		print "<TR><TD><input type='button' class='button_novo' id='idBtIncluir' value='".TRANS('TXT_INCLUDE_UNIT','',0)."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=incluir&cellStyle=true');\"></TD></TR><br><br>";
