  ...
  */session_start();
	...
	if ((isset($_GET['action']) && ($_GET['action'] == "incluir")) && !isset($_POST['submit']) ) {
		...
		print "<td class='line'>".TRANS('COL_DATE')."</td>".
			...
			"</td>";
		print "</tr>";
		print "<tr><td class='line'><input type='submit'  class='button_ok' name='submit' value='".TRANS('BT_CAD')."'></td>";

		print "<td class='line'><input type='reset'  class='button_ca' name='reset' value='".TRANS('BT_CANCEL')."' onClick=\"javascript:history.back()\"></td></tr>";
	...
	if ( (isset($_GET['action']) && $_GET['action']=="alter") && !isset($_POST['submit'])) {
		...
		print "<tr><td class='line'><input type='submit'  class='button_ok' name='submit' value='".TRANS('BT_ALTER')."'></td>";
		print "<td class='line'><input type='reset'  class='button_ca' name='reset' value='".TRANS('bt_cancelar')."' onclick=\"javascript:history.back()\"></td></tr>";
