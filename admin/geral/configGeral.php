<?php 
  ...
  */session_start();
	...
	if ((isset($_GET['action']) && ($_GET['action']=="alter")) && empty($_POST['submit'])){
		...
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<tr><td><input type='submit'  class='button_ok' name='submit' value='".TRANS('BT_ALTER','',0)."'></td>";
		print "<td><input type='reset' name='reset'  class='button_ca' value='".TRANS('BT_CANCEL','',0)."' onclick=\"javascript:history.back()\"></td></tr>";
