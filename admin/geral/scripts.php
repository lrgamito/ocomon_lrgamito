<?php 
  ...
  */session_start();
	...
	if ((isset($_GET['action'])  && ($_GET['action'] == "incluir") )&& empty($_POST['submit'])) {
		...
		print "<tr><td colspan='4'>&nbsp;</td></tr>";
		print "<TR>";
		print "<TD align='center' colspan='2' bgcolor='".BODY_COLOR."'><input type='submit'  class='button_ok' value='".TRANS('BT_CAD')."' name='submit'>";
		print "</TD>";
		print "<TD colspan='2' bgcolor='".BODY_COLOR."'><INPUT type='reset'  class='button_ca' value='".TRANS('bt_cancelar')."' name='cancelar' onClick=\"javascript:history.back()\"></TD>";
