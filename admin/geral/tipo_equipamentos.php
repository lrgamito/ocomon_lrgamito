<?php 
  ...
  */session_start();
	...
	if ((isset($_GET['action'])  && $_GET['action']=="incluir") && (!isset($_POST['submit']))) {
		...
		print "<tr><td class='line'><input type='submit' class='button_ok' name='submit' value='".TRANS('bt_cadastrar')."'></td>";
		print "<td class='line'><input type='reset' name='reset' class='button_ca' value='".TRANS('bt_cancelar')."' onclick=\"redirect('tipo_equipamentos.php')\"></td></tr>";
	...
	if ((isset($_GET['action'])  && $_GET['action']=="alter") && (!isset($_POST['submit']))) {
		...
		print "<tr><td class='line'><input type='submit' class='button_ok' name='submit' value='".TRANS('BT_ALTER','',0)."'></td>";
		print "<td class='line'><input type='reset' name='reset' class='button_ca' value='".TRANS('bt_cancelar','',0)."' onclick=\"redirect('tipo_equipamentos.php')\"></td></tr>";
