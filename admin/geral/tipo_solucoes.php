<?php 
  ...
  */session_start();
	...
	if ((isset($_GET['action'])  && $_GET['action']=="incluir") && (!isset($_POST['submit']))) {
		...
		print "<td class='line'><input type='reset' name='reset' class='button_ca' value='".TRANS('bt_cancelar')."' onclick=\"redirect('".$_SERVER['PHP_SELF']."')\"></td></tr>";
	...
	if ((isset($_GET['action'])  && $_GET['action']=="alter") && (!isset($_POST['submit']))) {
		...
		print "<td class='line'><input type='reset' name='reset' class='button_ca' value='".TRANS('bt_cancelar','',0)."' onclick=\"redirect('".$_SERVER['PHP_SELF']."')\"></td></tr>";
