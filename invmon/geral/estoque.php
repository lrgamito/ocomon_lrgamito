<?php 
  ...
  */session_start();
	...
	print "<TABLE border='0' align='left' ".$cellStyle."  width='70%' bgcolor='".BODY_COLOR."'>";
...
// 		print $query."<br>";
	...
	if ((!isset($_GET['action'])) && (empty($_POST['submit']) || $_POST['submit'] == TRANS('BT_SEARCH')) ) {
		...
		print "<TR>".
				...
				"<input type='button' class='button_novo' id='idBtIncluir' value='".TRANS('LINK_CAD_ITEM_SUPPLY','',0)."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=incluir&cellStyle=true');\">".
				"</TD>".

				"<TD colspan='3' bgcolor='".BODY_COLOR."'>".
				"<input type='button' class='button_pesquisar' id='idBtSearch' value='".TRANS('LINK_SEARCH_ITEM','',0)."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=search&cellStyle=true');\">".
				"</TD>".
		...
		if (mysql_num_rows($resultado) == 0){
			...
			print "<TD align='left' colspan='2'>".
					"<input type='button' class='button_novo' id='idBtIncluir' value='".TRANS('TTL_INCLUDE_COMP_MODEL','',0)."' onClick=\"redirect('itens.php?action=incluir&cellStyle=true');\">".
					"</td>";
			print "</tr>";
...
/*			print "<select class='select' name='estoque_desc' id='idDesc'>";
		...
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_sn' id='idSN'></TD>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_LOCAL')."</option>";
		...
		print "</TD>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_UNIT')."</option>";
		...
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_partnumber' id='idPartnumber'></TD>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_VENDOR')."</option>";
		...
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' ".$readOnlyDateField." name='estoque_date_buy' id='idDatebuy'>".
				"<a onmouseover='cursor:pointer;' onclick=\"displayCalendar(document.forms[0].estoque_date_buy,'dd-mm-yyyy',this)\">".
				"<img height='16' width='16' style='margin-left:8px;' src='../../includes/javascript/img/cal.gif' width='16' height='16' border='0' alt='".TRANS('SEL_DATE')."'>".
				"</a>".
			"</TD>";
        	print "</TR>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_WARRANTY')."</option>";
		...
		print "</TD>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_CCUSTO')."</option>";
		...
		print "</TD>";
			...
			print "<option value=0 selected>".TRANS('OCO_SEL_SITUAC')."</option>";
		...
		NL(2); //new line
		print "<tr>";
		print "<TD align='left' width='20%' bgcolor='".BODY_COLOR."'><input type='submit' class='button_ok' value='".TRANS('BT_CAD')."' name='submit'>";
		print "</TD>";
		print "<TD align='left'  bgcolor='".BODY_COLOR."'><INPUT type='reset' class='button_ca' value='".TRANS('BT_CANCEL')."' name='cancelar' onClick=\"".$fecha."\"></TD>";
	...
	if ((isset($_GET['action'])  && ($_GET['action'] == "search") )&& empty($_POST['submit'])) {
		...
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_tag' id='idTag'></TD>";
        	print "</TR>";
                ...
                NL(2); //new line
		print "<tr>";
		print "<TD align='left' width='20%' bgcolor='".BODY_COLOR."'><input type='submit' class='button_pesquisar' value='".TRANS('BT_SEARCH')."' name='submit'>";
		print "</TD>";
