...
//		print "</TD>";
		...
		print "<TR>";
		print "<TD  align='left' bgcolor='".TD_COLOR."'><b>".TRANS('FIELD_CDROM')."/DVD:</b></TD>";
		print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
...
//		print "</TD>";
		...
		print "<TR>";
		print "<TD colspan='2' align='center'  bgcolor='".BODY_COLOR."'><br><input type='button' value='  ".TRANS('BT_OK')."  ' class='button_pesquisar' name='ok' onClick='javascript:submitForm()'></td>";
		print "<TD colspan='2' align='center'  bgcolor='".BODY_COLOR."'><br><INPUT type='reset' value='".TRANS('BT_CANCEL')."'  class='button_ca' onClick='javascript:history.back()'></TD>";
		print "</TR>";
