...
?>
		...
		<p align='left'><b><?php print TRANS('TTL_ALTER_PASS');?></b></p>
		<FORM method="POST" action="<?php print $_SERVER['PHP_SELF'];?>" onSubmit="return valida()">
		<center><TABLE border="0"  align="left" width="30%" bgcolor=<?php print BODY_COLOR?>>
        <TR>
	...
	<tr>
                ...
                <TD align="left" width="25%" bgcolor=<?php print BODY_COLOR?>><input type="submit" class='button_ok'  value="<?php print TRANS('BT_ALTER');?>" name="ok">
                </TD>
			<TD align="left" width="25%" bgcolor=<?php print BODY_COLOR?>><INPUT type="button"  class='button_ca' value="<?php print TRANS('BT_CANCEL');?>" name="desloca" ONCLICK="javascript:history.back()">
                </TD>
