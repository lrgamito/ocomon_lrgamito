...
// 	print "</tr>";
	...
	NL(4);
	print "<TR>";
		print "<TD bgcolor='".BODY_COLOR."'><input type='submit' class='button_pesquisar' value='".TRANS('MNL_CON')."' name='ok'>";
		print "</TD>";
		print "<TD colspan='3' bgcolor='".BODY_COLOR."'>".
			"<INPUT type='reset' value='".TRANS('BT_CANCEL')."' class='button_ca' onClick='javascript:history.back()'></TD>";
	print "</TR>";
