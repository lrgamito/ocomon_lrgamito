...
<?php 
	...
	print "<TR>";
		...
		print "<TD align='center' bgcolor='".BODY_COLOR."'><input type='submit' class='button_pesquisar' value='".TRANS('MNL_CON')."' name='ok'>";
		print "</TD>";
		print "<TD align='center' bgcolor='".BODY_COLOR."'>".
			"<INPUT type='reset' class='button_ca' value='".TRANS('BT_CANCEL')."' onClick='javascript:history.back()'></TD>";
	print "</TR>";
	print "</table>";
	print "</form>";
