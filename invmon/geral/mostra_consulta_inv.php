 	...
 	if (isset($_REQUEST['comp_inv'])) {
		...
		else
		{
			...
			while ($row = mysql_fetch_array($resultado)) {
				...
				geraLog(LOG_PATH.'invmon.txt',date ("d-m-Y H:i:s"),$_SESSION['s_usuario'],$_SERVER['PHP_SELF'],$texto);
					...
					if ($_SESSION['s_ocomon']==1){
						print "<td  width='10%' align='center'>
							<br><B><a href=\"#\" onClick= \"javascript: popup_alerta('ocorrencias.php?popup=true&comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_OCCO_EQUIP')."'><img src='".$iconPath."inv_oco.png'><br>".TRANS('MNS_OCORRENCIAS')."</a></B><br>
							</td>";
					}

					print " <td width='10%' align='center'>";
					if ($row['tipo'] == 1 || $row['tipo']== 2){//Se o equipamento não for do tipo computador não terá softwares
						print "<br><B><a class='botao' href='#' onClick= \"javascript: popup_alerta('comp_soft.php?popup=true&comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_SW_INSTALL')."'><img src='".$iconPath."inv_sw.png'><br>".TRANS('MNL_SW')."</a></B><br>";
					}
					print "</td>";

					print "<td width='10%' align='center'><br><B><a href='#' class='botao' ".
							"onClick= \"javascript: popup_alerta('hw_historico.php?inv=".$row['etiqueta']."&inst=".$row['cod_inst']."')\" ".
							"title='".TRANS('HNT_HISTORY_ALTER_COMP')."'><img src='".$iconPath."inv_hwd.png'><br>".TRANS('LINK_HISTORY_EXCHANGE')."</a></B><br>";
					print "</td>";


					print "<td width='10%' align='center'><br><B><a href='#' class='botao' ".
							"onClick= \"javascript: popup_alerta('mostra_historico.php?popup=true&comp_inv=".$row['etiqueta']."".
							"&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_HISTORY_LOCAL_EQUIP')."'><img src='".$iconPath."inv_loc.png'><br>".TRANS('MNL_LOCAIS')."</a></B><br>";
					print "</td>";
					print "<td width='10%'  align='center'><br><B><a href='#' class='botao' ".
							"onClick= \"javascript: popup_alerta('consulta_garantia.php?popup=true&comp_inv=".$row['etiqueta']."".
							"&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_INFO_GARANT_EQUIP')."'><img src='".$iconPath."inv_gar.png'><br>".TRANS('LINK_GUARANT')."</a></B><br>";
					print "</td>";

					print "<td width='10%'  align='center'><br><B><a href='#' class='botao' ".
							"onClick=\"javascript: popup_alerta('docs_assoc_model.php?popup=true&model=".$row['modelo_cod']." ')\" ".
							"title='".TRANS('HNT_DOCS_ASSOC_EQUIP')."'><img src='".$iconPath."inv_doc.png'><br>".TRANS('LINK_DOCUMENTS')."</a></B><br>";
					print "</td>";

					if ($_SESSION['s_invmon']==1){
						print "<td width='10%'  align='center'>
							<br><B><a class='botao' href='altera_dados_computador.php?comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."'><img src='".$iconPath."inv_alt.png'><br>".TRANS('LINK_ALTER_DATA')."</a></B><br>
							</td>";
					}
					print "</tr>";
					print "</table>";
				...
				print "<TABLE border='0'  align='left' width='1200' >";
...
//by LRG
					...
					print "<TD class='borda' width='30%' align='left' ><a href='mostra_consulta_comp.php?".
							"comp_leitor=".$row['cod_leitor']."' title=' ".$row['fabricante_leitor']." ".$row['leitor']." ".TRANS('HNT_CAD_IN_SYSTEM')."'>".$row['fabricante_leitor']." ".$row['leitor']."</a>".
						"</TD>";
					print "</TR>";
					...
					print "<TD class='borda' width='30%' align='left' ><a href='mostra_consulta_comp.php?".
							"comp_os=".$row['cod_os']."' title='Sistema Operacional'> ".$row['fabricante_os']." ".$row['os']."</a>".
						"</TD>";
						
					//Serial OS
					print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>Serial OS:</b></TD>";
					print "<TD class='borda' width='30%' align='left' ><a href='mostra_consulta_comp.php?".
							"comp_sn_os=".$row['sn_os']."' title=' Serial OS'>".$row['sn_os']." </a>".
						"</TD>";
					print "</TR>";
