  ...
  */session_start();
	...
	if ((isset($_GET['LOAD']) && $_GET['LOAD'] !=-1)) {
		...
		$queryA = "SELECT ".
			...
			"leitor.mdit_fabricante as fabricante_leitor, leitor.mdit_desc as leitor, leitor.mdit_cod as cod_leitor, ". // add LRG
			"os.mdit_fabricante as fabricante_os, os.mdit_desc as os, os.mdit_cod as cod_os, ". 						// add LRG
		//	"sn_os.mdit_fabricante as fabricante_sn_os, sn_os.mdit_desc as sn_os, sn_os.mdit_cod as cod_sn_os, ". 		// add LRG
		...
		"FROM ((((((((((((((((((((moldes as mold ".
			...
			"left join modelos_itens as leitor on leitor.mdit_cod = mold.mold_leitor) ". // add LRG
			"left join modelos_itens as os on os.mdit_cod = mold.mold_os) ".			// add LRG
		...
		$resultadoA = mysql_query($queryA) or die (TRANS('MSG_ERR_LOAD_MODEL').'<BR><BR>'.$queryA);
...
/*		if (mysql_num_rows($resultadoA)>0)
	...
	print "<TABLE border='0' colspace='3' width='1100'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_MANUF')."'><font color='".$corzinha."'>".TRANS('COL_MANUFACTURE').":*</font></a></b>".
			"</TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				...
				"<font color='".$corzinha."'>".TRANS('OCO_FIELD_TAG')."*:</font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_inv'  ".
				" id='idEtiqueta'></TD>";

		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color='".$corzinha."'>".TRANS('COL_SN')."*:</font> </b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_sn'></TD>";
		print "</TR>";

		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_EQUIP_CAD')."'><font color='".$corzinha."'>".TRANS('COL_MODEL')."*:</font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
			print "<SELECT class='select' name='comp_marca' size='1' id='idModelo' >";
				...
				print "&nbsp;<img src='../../includes/icons/mais.png' alt='".TRANS('NEW')."'  style='cursor: pointer;' onClick=\"javascript:popup_alerta('modelos.php?popup=true')\">";
                                print "&nbsp;<img src='../../includes/icons/reload_page.png' alt='".TRANS('BT_LOAD_CONFIG')."' style='cursor: pointer;' onClick=\"redirectLoad('".$_SERVER['PHP_SELF']."?LOAD=','idModelo');\" />";
                                print "&nbsp;<img src='../../includes/icons/go-jump.png' alt='".TRANS('BT_CAD_CONFIG')."' style='cursor: pointer;' onClick=\"redirect('incluir_molde.php')\"/>";
                                
               print "</td>";

		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_EQUIP_LOCAL')."'>".
				"<font color='".$corzinha."'>".TRANS('COL_LOCAL')."*:</font></a></b></TD>";
		...
		print "</tr>";
		//print "<tr>";
		/*print "<td colspan='2' width='20%' align='left'>
                                <input type='button' class='button' value='".TRANS('BT_LOAD_CONFIG')."' name='ok2' ".
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_SIT_EQUIP')."'><font color='".$corzinha."'>".TRANS('COL_SITUAC')."*:</font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<tr><td colspan='3'><b>".TRANS('SUBTTL_INFO_CONFIG_EQUIP').":</b></td><td class='line'>".
				"<a style='cursor:pointer;' Onclick=\"return popup_alerta('itens.php?action=incluir&cellStyle=true&popup=true')\">
                                <img src='../../includes/icons/mais.png'  alt='".TRANS('TTL_INCLUDE_COMP')."' ".
				"> ".TRANS('TTL_INCLUDE_COMP')."</a></td>".
			"</tr>";
		print "<TR><td colspan='4'></td></TR>";
...
//		print "</tr>";
			...
			// by LRG
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b> Leitor de Cartão: </b></TD>";
			print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
			print "<SELECT class='select' name='comp_leitor' size='1'>";

					print "<option value=null selected>".TRANS('SEL_MODEL')."</option>";

				$query = "select * from modelos_itens where mdit_tipo = 13 order by mdit_fabricante, mdit_desc";
				$commit = mysql_query($query);
				while($rowA = mysql_fetch_array($commit)){
					print "<option value='".$rowA['mdit_cod']."' ";
					if (isset($queryA) && $rowA['mdit_cod'] == $row['cod_leitor'])
						print " selected";
					print ">".$rowA['mdit_fabricante']." ".$rowA['mdit_desc']." ".$rowA['mdit_desc_capacidade']."".$rowA['mdit_sufixo']."</option>";
				} // while
				print "<option value=null>".TRANS('SEL_NONE')."</option>";
		...
		// by LRG
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('FIELD_CDROM')."/DVD: </b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
...
//		print "</tr>";
				...
				//by LRG
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>Sistema Operacional: </b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
			print "<SELECT class='select' name='comp_os' size='1'>";

					print "<option value=null selected>".TRANS('SEL_MODEL')."</option>";

				$query = "select * from modelos_itens where mdit_tipo = 14 order by mdit_fabricante, mdit_desc";
				$commit = mysql_query($query);
				while($rowA = mysql_fetch_array($commit)){
					print "<option value='".$rowA['mdit_cod']."' ";
					if (isset($queryA) && $rowA['mdit_cod'] == $row['cod_os'])
						print " selected";
					print ">".$rowA['mdit_fabricante']." ".$rowA['mdit_desc']." ".$rowA['mdit_desc_capacidade']."".$rowA['mdit_sufixo']."</option>";
				} // while
				print "<option value=null>".TRANS('SEL_NONE')."</option>";
		...
		//by LRG
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>Serial OS:</b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_sn_os' maxlength='30'></TD>";
		//end
		print "<TR><td colspan='4'></td></TR>";
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_UNIT_PROP')."'><font color='".$corzinha."'>".TRANS('OCO_FIELD_UNIT')."*:</font></a>"."
				</b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color='".$corzinha."'>".TRANS('COL_VENDOR')."*: </font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color='".$corzinha."'>".TRANS('FIELD_FISCAL_NOTES')."*:</font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_nf'></TD>";
		print "</tr>";
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color='".$corzinha."'>".TRANS('FIELD_VALUE')."*:</font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_valor' id='idValor'></TD>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color='".$corzinha."'>".TRANS('FIELD_DATE_PURCHASE')."*:</font></b></TD>";
		...
		print "</TR>";
                ...
                print "<TR height='10px'><TD></TD></TR>";
                
		print "<TR>";
		print "<TD colspan='2'  align='center' bgcolor='".BODY_COLOR."'><input type='submit' value='".TRANS('BT_CAD')."' name='submit' ".
				"class='button_ok' title='".TRANS('MSG_CAD_INFO_SUPP')."'>";
		print "</TD>";
		print "<TD colspan='2' align='center' bgcolor='".BODY_COLOR."'><INPUT type='reset' value='".TRANS('BT_CANCEL')."' ".
				"class='button_ca' onClick=\"javascript:history.back()\"></TD>";
		print "</TR>";
...
// 				if ($_POST['comp_garant_meses'] == -1) { $comp_garant_meses = "null";} else $comp_garant_meses = "'$comp_garant_meses'";
				...
				$query = "INSERT INTO equipamentos ".
							...
							"comp_leitor, comp_os, comp_sn_os)".		//by LRG															
						"VALUES ('".$_POST['comp_inv']."','".noHtml($_POST['comp_sn'])."','".$_POST['comp_marca']."',".
							...
							"".$_POST['comp_modem'].", ".$_POST['comp_cdrom'].", 0, ".
							"0,'".noHtml($_POST['comp_nome'])."', '".$_POST['comp_local']."', ".
							...
							"".$_POST['comp_leitor'].", ".$_POST['comp_os'].", '".$_POST['comp_sn_os']."' )"; //by LRG
					...
					//GRAVA LOG
						...
						$mensagem_log  	= "Inclusão de Equipamento - ETIQUETA: ".$_POST['comp_inv']." - INSTITUICAO: ".$_POST['comp_inst'];
						$mensagem_log 	= $mensagem_log." | ".$_POST['comp_sn']." | ".$_POST['comp_marca']." | ".$_POST['comp_local']." | ".$_POST['comp_situac'];
						$usu_logado 	= $_SESSION['s_usuario'];
						$etiqueta		= $_POST['comp_inv'];
						setLog($mensagem_log,$etiqueta,$usu_logado);
...
<!--
	...
	function valida(){
		...
		if (ok) var ok = validaForm('idEtiqueta','ALFAFULL','<?php print TRANS('OCO_FIELD_TAG');?>',1);
