			...
			print "<TABLE border='0' cellpadding='2' cellspacing='0' width='90%'>";
				...
				print "<tr>".//<td>".TRANS('FIELD_SEARCH')."</td>".
						"<td colspan='4'><input type='text' class='text' name='search' id='idSearch' value='".$search."'>&nbsp;".
							"<input type='submit' name='BT_SEARCH' class='button_pesquisar' value='".TRANS('BT_FILTER')."' onClick=\"LOAD=1;\">".
						"</td></tr>";
				if (isset($_POST['search'])) {
		...
		print "<TR>";
			print "<TD colspan='2' align='center' width='50%' bgcolor='".BODY_COLOR."'>".
				...
				if (isset($_REQUEST['numero'])) {
					...
					print "<input type='submit'  class='button_ok' value='".TRANS('BT_SEND')."' name='submit' onClick=\"LOAD=0;\">";
			print "</TD>";
			print "<TD colspan='2' align='center' width='50%' bgcolor='".BODY_COLOR."'>".
					"<INPUT type='button'  class='button_ca' value='".TRANS('BT_CANCEL')."' name='desloca' onClick=\"window.close();\">".
				"</TD>";
		print "</TR>";
