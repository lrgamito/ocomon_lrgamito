  ...
  */
	...
	print "</TR>".
		...
		if ($regs > 0) {
			...
			$qry = "INSERT INTO usuarios (login,nome,password,data_inc,data_admis,email,fone,nivel,AREA, user_admin) ".
			...
			if ($exec_qry) {
				...
				if (!$execdel) {
					$msg.= "ERRO NA EXCLUSAO DO REGISTRO TEMPORÁRIO!" .  mysql_error();;
				}

			} else {
				$msg = "HOUVE UM ERRO NA INCLUSÃO DOS DADOS!<br>".$qry."<br>".  mysql_error();
			}
