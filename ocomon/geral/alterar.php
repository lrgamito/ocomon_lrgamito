...
*/session_start();
	...
	print "<TR>";
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
                print "<TD align='left' width='20%' bgcolor='".BODY_COLOR."'>".
                		"<input type='submit'  class='button_pesquisar' value='".TRANS('BT_OK','',0)."' name='submit'>";
		print "</TD>";
                print "<TD align='left' width='80%' bgcolor='".BODY_COLOR."'>".
                		"<INPUT type='button'  class='button_ca' value='".TRANS('BT_CANCEL','',0)."' name='cancela' onClick=\"redirect('abertura.php');\">".
                	"</TD>";
	print "</TR>";
	...
	<!--
		function valida(){
			...
			var ok = validaForm('idEtiqueta','ALFAFULL','Ocorrências',1);
