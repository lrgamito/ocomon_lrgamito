...
// 		$linkEdita = "";
	...
	<script type='text/javascript'>
		...
		function popup_alerta(pagina)	{ //Exibe uma janela popUP
			x = window.open(pagina,'_blank','dependent=yes,width=1100,height=600,scrollbars=yes,statusbar=no,resizable=yes');
	...
	if ($row['status_cod']!=4 && $_SESSION['s_nivel'] < 3) {
		print "<TD align='center' width='10%' ><a href='encerramento.php?numero=".$row['numero']."'><img src='".$iconPath."oco_enc.png' alt='' /><br>".TRANS('FIELD_FINISH_OCCO')."</a></TD>"; //
	}

	print "<TD align='center' width='10%' ><a href='mostra_relatorio_individual.php?numero=".$row['numero']."' target='_blank'><img src='".$iconPath."oco_print.png' alt=''><br>".TRANS('FIELD_PRINT_OCCO')."</a></TD>"; 
	if ($_SESSION['s_nivel'] < 3)
		print "<TD align='center' width='10%' ><a href='encaminhar.php?numero=".$row['numero']."'><img src='".$iconPath."oco_edit.png' alt='' /><br>".TRANS('FIELD_EDIT_OCCO')."</a></TD>"; 

	if (($row['status_cod']!=2) && ($row['status_cod']!=4) && ($_SESSION['s_nivel'] < 3)) {
		print "<TD align='center' width='10%' ><a href='atender.php?numero=".$COD."'><img src='".$iconPath."oco_ate.png' alt='' /><br>".TRANS('FIELD_ADVERT')."</a></TD>"; 
	}

	print "<TD align='center' width='10%' ><a href='#' onClick=\"javascript:popup('mostra_sla_definido.php?popup=true&numero=".$row['numero']."')\"><img src='".$iconPath."oco_sla.png' alt='' /><br>".TRANS('COL_SLA')."</a></TD>";

	if ($row['status_cod']!=4 && $_SESSION['s_nivel'] < 3) {
		print "<TD align='center' width='10%' bgcolor='".BODY_COLOR."' ><a href='#' onClick=\"javascript:popup_alerta('incluir.php?popup=true".
				"&pai=".$row['numero']."&invTag=".$row['etiqueta']."&invInst=".$row['unidade_cod']."&invLoc=".$row['setor_cod']."".
				"&contato=".$row['contato']."&telefone=".$row['telefone']."')\"><img src='".$iconPath."oco_sub.png' alt='' /><br>".TRANS('FIELD_OPEN_SUBCALL')."</a></TD>";
	}

	if ($row['status_cod']==4 && $_SESSION['s_allow_reopen']) {//CHECAGEM PARA PERMITIR QUE O CHAMADO SEJA REABERTO NO SISTEMA.
		print "<TD align='center' width='10%' bgcolor='".BODY_COLOR."' >".
			"<a href='#' onClick=\"confirma('".TRANS('ENSURE_REOPEN')."?','".$_SERVER['PHP_SELF']."?action=reopen&numero=".$COD."')\"><img src='".$iconPath."oco_reop.png' alt='' /><br>
	...
	print "<TD align='center' width='10%' bgcolor='".BODY_COLOR."'  ><a href='#' onClick=\"javascript:popup('tempo_doc.php?popup=true".
			"&cod=".$row['numero']."')\"><img src='".$iconPath."oco_timdoc.png' alt='' /><br>".TRANS('FIELD_TIME_DOCUMENTATION')."</a></TD>";

	if ($_SESSION['s_nivel'] < 3) {
		print "<TD align='center' width='10%' bgcolor='".BODY_COLOR."'><a href='#' onClick=\"javascript:popupS('form_send_mail.php?popup=true".
			"&numero=".$row['numero']."')\"><img src='".$iconPath."oco_mail.png' alt='' /><br>".TRANS('SEND_EMAIL')."</a></TD>"; 
	}
	...
	print "<TR>";
		...
		print "<TD  width='30%' align='left'>".
				"<a href='#' onClick=\"popup_alerta('../../invmon/geral/mostra_consulta_inv.php?".
        ...
        if ($row['status_cod'] == 4)
	{
		...
		print "<tr>";
			...
			print "<TD colspan='5' align='left'  >".
					"<font color='blue'><u><a href='#' onClick=\"popup_alerta_mini('mostra_hist_status.php?numero=".$COD."&popup=true')\">".
        ...
        else
	{
		...
		print "<TR>";
			...
			print "<TD width='30%' align='left'  >".
					"<b><font color='blue'><u><a href='#' onClick=\"popup_alerta_mini('mostra_hist_status.php?numero=".$COD."&popup=true')\">".
