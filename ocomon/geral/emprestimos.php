<?php 
  ...
  */session_start();
	...
	print "<TABLE border='0' align='left' ".$cellStyle."  width='1100px' bgcolor='".BODY_COLOR."'>";
	...
	if ((!isset($_GET['action'])) && !isset($_POST['submit'])) {
		...
		print "<TR><TD bgcolor='".BODY_COLOR."'>".
				"<input type='button' class='button_novo' id='idBtIncluir' value='".TRANS('BT_NEW_LOAN')."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=incluir&cellStyle=true');\">".
				"</TD></TR>";
	...
	if ((isset($_GET['action'])  && ($_GET['action'] == "incluir") )&& !isset($_POST['submit'])) {
		...
		print "<TR>";
		print "<TD colspan='2' align='center' width='20%' bgcolor='".BODY_COLOR."'><input type='submit'  class='button_ok' value='".TRANS('BT_CAD')."' name='submit'>";
		print "</TD>";
		print "<TD colspan='2' align='center' width='80%' bgcolor='".BODY_COLOR."'><INPUT type='reset'  class='button_ca' value='".TRANS('BT_CANCEL')."' name='cancelar' onClick=\"redirect('".$_SERVER['PHP_SELF']."')\"></TD>";
	...
	if ((isset($_GET['action']) && $_GET['action']=="alter") && empty($_POST['submit'])) {
		...
		print "<TR>";
		print "<TD align='center' width='20%' colspan='2' bgcolor='".BODY_COLOR."'><input type='submit'  class='button_ok' value='".TRANS('BT_ALTER')."' name='submit'>";
		print "<input type='hidden' name='cod' value='".$_GET['cod']."'>";
			print "</TD>";
		print "<TD align='center' colspan='2' width='80%' bgcolor='".BODY_COLOR."'><INPUT type='reset'  class='button_ca' value='".TRANS('BT_CANCEL')."' name='cancelar' onClick=\"javascript:history.back()\"></TD>";
