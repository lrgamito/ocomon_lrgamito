...
// 	}
	...
	if (!isset($_POST['submit'])) {
		...
		print "<td align='left'><input type='submit' name='submit' class='button_ok' value='".TRANS('BT_LOAD','',0)."'></td>".
				"<td align='left'><input type='button' name='cancelar' class='button_ca' value='".TRANS('BT_CANCEL')."' onClick=\"javascript:history.back();\"></td>";
		print "</tr>";
