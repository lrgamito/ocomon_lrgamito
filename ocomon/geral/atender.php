...
*/session_start();
	...
	if (!isset($_POST['submit'])) {
		...
		print "<TABLE border='0'  align='left' cellpadding='3' cellspacing='2' width='1100' bgcolor='".BODY_COLOR."'>";
		print "<TR>";
		...
		print "<TR>";
			...
			print "<TD width='30%' align='left' bgcolor='WHITE'>".$row['problema']."</TD>";
		...
		print "<TR>";
			...
			print "<TD width='30%' align='left' bgcolor='WHITE'>".$row['unidade']."</TD>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('FIELD_TAG_EQUIP').":</TD>";
			print "<TD colspan='3' width='30%' align='left' bgcolor='WHITE'>".$row['etiqueta']."</TD>";
		print "</TR>";

		print "<TR>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_CONTACT').":</TD>";
			print "<TD width='30%' align='left' bgcolor='WHITE'>".$row['contato']."</TD>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_PHONE').":</TD>";
			print "<TD colspan='3' width='30%' align='left' bgcolor='WHITE'>".$row['telefone']."</TD>";
		print "</TR>";

		print "<TR>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_LOCAL').":</TD>";
			print "<TD width='30%' align='left' bgcolor='WHITE'>".$row['setor']."</TD>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_OPERATOR').":</TD>";
			print "<TD colspan='3' width='30%' align='left' bgcolor='WHITE'>".$row['nome']."</TD>";
		print "</TR>";

		print "<TR>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_DATE_OPEN').":</TD>";
			print "<TD width='30%' align='left' bgcolor='WHITE'>".formatDate($row['data_abertura'])."</TD>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('OCO_FIELD_STATUS').":</TD>";
			print "<TD colspan='3' width='30%' align='left' bgcolor='WHITE'>".$row['chamado_status']."</TD>";
		print "</TR>";
