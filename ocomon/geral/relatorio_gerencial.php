...
else //if $ok==Pesquisar
{
	...
	//<GAMBIARRA>
	$SW = 4; $HW = '1,2,3';//CÓDIGOS DAS ÁREAS HELPDESK E CONSTAT (SOFTWARE E HARDWARE)//
	$SW_PREV = 51; $HW_PREV = 50; //CÓDIGOS DAS PREVENTIVAS DE SOFTWARE E HARDWARE//
	...
	else
	{
		...
		//----------TABELA 9 -------------------//
			...
			print "<tr><td class='line'>INFORMATICA</td><td class='line'>".$media_resposta_valida_hw."</td><td class='line'>".$media_solucao_valida_hw."</td></tr>";
			print "<tr><td class='line'>DESENVOLVIMENTO</td><td class='line'>".$media_resposta_valida."</td><td class='line'>".$media_solucao_valida."</td></tr>";
			print "</table><br><br>";
			print "</blockquote>";
			//------------ FINAL DA TABELA 15 -----------------//

			$nome = "titulo=MÉDIA DE TEMPOS DE RESPOSTA PARA CHAMADOS DE DESENVOLVIMENTO";
			...
			// --------------- TABELA 16  -----------------//
			print "<p>MÉDIA SLA POR CHAMADOS DE DESENVOLVIMENTO - RESPOSTA</p>";
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			...
			$nome = "titulo=MÉDIA DE TEMPOS DE SOLUÇÃO PARA CHAMADOS DE DESENVOLVIMENTO";
			...
			// --------------- TABELA 17  -----------------//
			print "<p>MÉDIA SLA POR CHAMADOS DE DESENVOLVIMENTO - SOLUÇÃO</p>";
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			...
			$nome = "titulo=MÉDIA DE TEMPOS DE RESPOSTA PARA CHAMADOS PARA INFORMATICA";
			...
			$legenda.= "legenda%5B%5D=mais de 60 minutos";
			// --------------- TABELA 18  -----------------//
			print "<p>MÉDIA SLA POR CHAMADOS PARA INFORMATICA - RESPOSTA</p>";
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td class='line'><b>RESPOSTA</b></td><td class='line'><b>QUANTIDADE</b></td><td class='line'><b>PERCENTUAL</b></td></tr>";
			...
			$nome = "titulo=MÉDIA DE TEMPOS DE SOLUÇÃO PARA CHAMADOS PARA INFORMATICA";
			...
			$legenda.= "legenda%5B%5D=mais de 6 horas";
			// --------------- TABELA 19  -----------------//
			print "<p>MÉDIA SLA POR CHAMADOS PARA INFORMATICA - SOLUÇÃO</p>";
			print "<blockquote>";
			print "<table cellspacing='0' border='1'>";
			print "<tr><td class='line'><b>SOLUÇÃO</b></td><td class='line'><b>QUANTIDADE</b></td><td class='line'><b>PERCENTUAL</b></td></tr>";
