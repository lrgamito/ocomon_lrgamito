<?php 
  ...
  */session_start();
	...
	print "<TABLE border='0'  align='left' width='1100px' bgcolor='".BODY_COLOR."'>";
        print "<TR>";
	...
	print "<TR>";
		print "<TD colspan='2' align='center' width='50%' bgcolor='".BODY_COLOR."'>".
				"<input type='submit' class='button_ok' value='".TRANS('BT_OK')."' name='submit' onClick='javascript:submitForm()'>";
		print "</TD>";
		print "<TD colspan='2' align='center' width='50%' bgcolor='".BODY_COLOR."'>".
				"<INPUT type='button'  class='button_ca' value='".TRANS('BT_CANCEL')."' name='cancela' onclick=\"redirect('abertura.php');\">";
		print "</td>";
	print "</TR>";
