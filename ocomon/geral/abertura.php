<?php session_start();
  ...
  */
	...
	if ($linhas == 0) {
		...
		print "<TR class='header'>";
			print "<TD    WIDTH='80' class='line' >".TRANS('OCO_NUMBER_BRIEF')."</TD>".
                                "<TD  WIDTH='80' class='line' >".TRANS('col_etiqueta')."</TD>".
                                "<TD  WIDTH='250' class='line' >".TRANS('OCO_PROB')."</TD>".
				"<TD  WIDTH='150' class='line' >".TRANS('OCO_CONTACT')."<BR>".TRANS('OCO_PHONE')."</TD>".
				"<TD  class='line' >".TRANS('OCO_LOCAL')."<BR>".  TRANS('OCO_DESC')."</TD>".
				"<TD  WIDTH='250' class='line' >".TRANS('OCO_STATUS')."</TD>".
...
// 				"".TRANS('OCO_PENDING')."</font>&nbsp;".TRANS('OCO_TO_USER','para o usuário')."&nbsp;".$_SESSION['s_usuario'].".</b></td></tr>";
		...
		print "<TR class='header'>";
			print "<TD  class='line' WIDTH='80'>".TRANS('OCO_NUMBER_BRIEF')."</TD>".
				"<TD class='line' WIDTH='80'>".TRANS('col_etiqueta')."</TD>".
                                "<TD class='line' WIDTH='250'>".TRANS('OCO_PROB','Problema')."</TD>".
				"<TD class='line' WIDTH='150'>".TRANS('OCO_CONTACT')."<BR>".TRANS('OCO_PHONE','Ramal')."</TD>".
				"<TD class='line'  >".TRANS('OCO_LOCAL')."<br>".TRANS('OCO_DESC')."</TD>".
				"<TD class='line' WIDTH='250'>".TRANS('OCO_STATUS')."</TD>".
...
// 	$PAGE->execSQL();
	...
	//FILA DE CHAMADOS
        print "  <TR class='header'>";
        print "  <TD  WIDTH='80'  class='line'  nowrap>".TRANS('OCO_NUMBER_BRIEF','N.º')."&nbsp;/&nbsp;<a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=AREA')\" title='Ordena por Área de atendimento'>".TRANS('OCO_AREA','Área')."".$ICON_ORDER_AREA."</a></TD>".
		"<TD  WIDTH='80'  class='line' >".TRANS('col_etiqueta')."</TD>".
        	"<TD  WIDTH='250' class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=PROB')\" title='Ordena por tipo de problema'>".TRANS('OCO_PROB')."".$ICON_ORDER_PROB."</a></TD>".
        	"<TD  WIDTH='150' class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=CONTATO')\" title='Ordena pelo contato'>".TRANS('OCO_CONTACT')."".$ICON_ORDER_CONTATO."</a><BR>".TRANS('OCO_PHONE','Ramal')."</TD>".
        	"<TD  class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=LOCAL')\" title='Ordena por Localização'>".TRANS('OCO_LOCAL')."".$ICON_ORDER_LOCAL."</a><br>".TRANS('OCO_DESC')."</TD>".
        	"<TD  WIDTH= '250' class='line' nowrap><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=DATA')\" title='Order by ".TRANS('HNT_VALID_TIME')."'>".TRANS('OCO_VALID_TIME')."".$ICON_ORDER_DATA."</a></TD>".
        	...
        	"<TD  class='line' ><a STYLE=\"cursor: pointer;\" onClick=\"redirect('".$_SERVER['PHP_SELF']."?&ORDERBY=PRIOR')\" title='Ordena por ".TRANS('HNT_PRIORITY')."'>".TRANS('P')."".$ICON_ORDER_PRIOR."</a></TD>".
        	"<TD  class='line' ><a title='".TRANS('HNT_RESPONSE_TIME')."'>".TRANS('OCO_RESPONSE')."</a></TD>".
