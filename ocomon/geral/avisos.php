  ...
  */session_start();
	...
	if ((!isset($_GET['action'])) && empty($_POST['submit'])) {
		...
		print "<tr><TD bgcolor=".BODY_COLOR.">".
				"<input type='button' class='button_novo' id='idBtIncluir' value='".TRANS('BT_NEW_NOTICE')."' onClick=\"redirect('".$_SERVER['PHP_SELF']."?action=incluir&cellStyle=true');\">".
			"</TD></tr>";
	...
	if (isset($_GET['action']) && ($_GET['action'] == "incluir") && empty($_POST['submit'])) {
		...
		print "<BR><B>".TRANS('TLT_INSERT_BOARD_NOTICE')."</B><BR>";
        	...
        	print "<TR>";
            	print "<TD align='center' colspan='2' width='20%' bgcolor='".BODY_COLOR."'><input type='submit'  class='button_ok' value='".TRANS('BT_CAD')."' name='submit'>";
           	print "</TD>";
            	print "<TD colspan='2' align='center' width='80%' bgcolor='".BODY_COLOR."'><INPUT type='reset'  class='button_ca' value='".TRANS('BT_CANCEL')."' name='cancelar' onclick=\"javascript:redirect('avisos.php');\"></TD>";
        	print "</TR>";
	} else
	...
	if ((isset($_GET['action']) && $_GET['action']=="alter") && empty($_POST['submit'])) {
		...
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<TR>";
		print "<TD align='center' colspan='2' width='20%' bgcolor=".BODY_COLOR."><input type='submit'  class='button_ok' value='".TRANS('BT_ALTER')."' name='submit'>";
