<?php 
  ...
  */session_start();
	...
	while ($rowAreas = mysql_fetch_array($execAreas)) {
		...
		//$a = 0;
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='100%' style='border-color: #ddd;'>";
		While ($rowStatus = mysql_fetch_array($execStatus)) {
			...
			print "<tr class='header'>".
                              "<td class='line' width='50'>".TRANS('COL_NUMBER')."</td>".
                              "<td class='line' width='50'>".TRANS('col_etiqueta')."</td>".
                              "<td class='line' width='250'>".TRANS('COL_PROB')."</td>".
                              "<td class='line' width='200'>".TRANS('OCO_CONTACT')."<br>".TRANS('OCO_PHONE')."</td>".
                              "<td class='line' >".TRANS('OCO_LOCAL')."<br>".TRANS('OCO_DESC')."</td>".
                              "<td class='line' width='200'>".TRANS('FIELD_LAST_OPERATOR')."</td></tr>";
			...
			while ($rowDetail = mysql_fetch_array($execDetail)){
				...
				print "<td class='line' width='50px'><a style='cursor: pointer;' onClick=\"javascript: popup_alerta('./ocomon/geral/mostra_consulta.php?popup=true&numero=".$rowDetail['numero']."')\">".$rowDetail['numero']."</a> ".$imgSub."</TD>";
				print "<td class='line' width='50px'>".$rowDetail['etiqueta']."</td>";
				//print "<td class='line'>".$rowDetail['numero']."</TD>";
				print "<td class='line' width='250px'>".$linkImg."&nbsp;".$rowDetail['problema']."</TD>";
				print "<td class='line' width='200px'><b>".$rowDetail['contato']."</b><br>".$rowDetail['telefone']."</TD>";
